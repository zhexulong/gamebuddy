...
/** Converts one exact authenticated Stardew client into the adapter-owned receipt-backed launch handle. */
export async function createStardewIntegrationLaunchHandleFromAuthenticatedBridge(
  ...
  options: Readonly<{ expectedPresentationLocale?: string; knowledge?: KnowledgeBundle; gameVersion?: string }> = {},
