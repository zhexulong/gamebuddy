...
function createHarness(initialNowMs = 1_000) {
  ...
  const composition = createStardewPrivateBootstrapComposerTestSupport({
    ...
    createGuardianRevision: () => "guardian-revision-bootstrap-test",
    createGuardianInstanceId: () => "guardian-instance-bootstrap-test",
    createGuardianEpoch: () => 1,
    createGuardianLeaseName: () => "Local\\GameBuddy-BootstrapTest-Lease",
    createGuardianPlayerJobName: () => "Local\\GameBuddy-BootstrapTest-Player",
    createGuardianAiJobName: () => "Local\\GameBuddy-BootstrapTest-Ai",
