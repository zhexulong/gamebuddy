...
import { checkM4BreakRockSourceContract, validateM4BreakRockSourceContract } from "./stardew-portfolio-m4-break-rock-source-contract.mjs";

const path = new URL("./stardew-portfolio-m4-break-rock-source-contract.json", import.meta.url);
const fixturePath = new URL("../fixtures/stardew/portfolio-m4-break-rock-source-unprovisioned.fixture.example.json", import.meta.url);
async function contract() { return JSON.parse(await readFile(path, "utf8")); }
