...
try {
  ...
  if (!client.state.capabilities.includes("equip_tool") || !snapshot.capabilities.includes("equip_tool")) throw new Error("equip_tool_capability_missing");
  ...
  if (receipt.state !== "succeeded" || receipt.reasonCode !== "tool_selected" || !/before=.*;expected=.*;after=/.test(evidenceDetail)) {
