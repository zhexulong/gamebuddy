...
const root = resolve(".");
const script = resolve("tools/check-stardew-portfolio-m6-machine-source-audit.mjs");
function run() {
...
test("M6 source-audit CLI revalidates authority, provenance metadata, and bounded local anchors", async () => {
