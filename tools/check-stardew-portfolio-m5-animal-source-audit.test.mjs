...
const root = resolve(".");
const script = resolve("tools/check-stardew-portfolio-m5-animal-source-audit.mjs");
function run() {
...
test("M5 source-audit CLI revalidates authority, provenance metadata, and bounded local anchors", async () => {
