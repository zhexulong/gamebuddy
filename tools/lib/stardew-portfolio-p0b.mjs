...
const PORTFOLIO_TARGET_GAME_VERSION = PORTFOLIO_CONTRACT_TARGET_VERSION;
const PORTFOLIO_TARGET_GAME_BUILD_NUMBER = PORTFOLIO_TARGET_BUILD_NUMBER;
...
const PORTFOLIO_START_MANIFEST_SCHEMA_VERSION = 1;
export const PORTFOLIO_INSTALLATION_ATTESTATION_SCHEMA_VERSION = 1;
const PORTFOLIO_START_MANIFEST_SIGNING_ALGORITHM = "hmac-sha256";
