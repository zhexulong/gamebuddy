...
export const PLAYER_COMMAND_BOUNDARY_CANDIDATES = Object.freeze([
  { ingressId: "world_action_interaction", expression: "currentLocation.CheckPetAnimal", candidateId: "animal.check_pet", semanticFamily: "animal_interaction", nativeRuleBoundaryCandidate: "GameLocation.CheckPetAnimal" },
  { ingressId: "world_action_interaction", expression: "currentLocation.CheckInspectAnimal", candidateId: "animal.inspect", semanticFamily: "animal_interaction", nativeRuleBoundaryCandidate: "GameLocation.CheckInspectAnimal" },
  { ingressId: "world_action_interaction", expression: "receiveActionPress", candidateId: "event.action_press", semanticFamily: "event_operation", nativeRuleBoundaryCandidate: "Event.receiveActionPress" },
  { ingressId: "world_action_interaction", expression: "StardewValley.GameLocation.checkAction", candidateId: "world.check_action", semanticFamily: "world_interaction", nativeRuleBoundaryCandidate: "Game1.tryToCheckAt -> GameLocation.checkAction" },
  { ingressId: "world_tool_use", expression: "currentLocation.checkAction", candidateId: "world.check_action", semanticFamily: "world_interaction", nativeRuleBoundaryCandidate: "GameLocation.checkAction" },
  { ingressId: "world_action_interaction", expression: "player.mount.checkAction", candidateId: "mount.check_action", semanticFamily: "mount_interaction", nativeRuleBoundaryCandidate: "Horse.checkAction" },
  { ingressId: "world_action_interaction", expression: "player.ActiveObject.performUseAction", candidateId: "item.perform_use_action", semanticFamily: "item_use", nativeRuleBoundaryCandidate: "Object.performUseAction" },
  { ingressId: "world_action_interaction", expression: "Utility.tryToPlaceItem", candidateId: "item.try_place", semanticFamily: "item_placement", nativeRuleBoundaryCandidate: "Utility.tryToPlaceItem" },
  { ingressId: "world_action_interaction", expression: "furniture.rotate", candidateId: "furniture.rotate", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.rotate" },
  { ingressId: "world_action_interaction", expression: "furniture2.rotate", candidateId: "furniture.rotate", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.rotate" },
  { ingressId: "world_action_interaction", expression: "furniture3.rotate", candidateId: "furniture.rotate", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.rotate" },
  { ingressId: "world_action_interaction", expression: "chooseResponse", candidateId: "dialogue.choose_response", semanticFamily: "dialogue_choice", nativeRuleBoundaryCandidate: "Dialogue.chooseResponse" },
  { ingressId: "world_action_interaction", expression: "currentLocation.answerDialogue", candidateId: "dialogue.answer_location", semanticFamily: "dialogue_choice", nativeRuleBoundaryCandidate: "GameLocation.answerDialogue" },
  { ingressId: "world_action_interaction", expression: "currentLocation.currentEvent.answerDialogue", candidateId: "event.answer_dialogue", semanticFamily: "event_choice", nativeRuleBoundaryCandidate: "Event.answerDialogue" },
  { ingressId: "world_action_interaction", expression: "animateSpecialMove", candidateId: "weapon.special_move", semanticFamily: "combat", nativeRuleBoundaryCandidate: "MeleeWeapon.animateSpecialMove" },
  { ingressId: "world_tool_use", expression: "currentLocation.checkAction", candidateId: "world.check_action", semanticFamily: "world_interaction", nativeRuleBoundaryCandidate: "GameLocation.checkAction" },
  { ingressId: "world_tool_use", expression: "value2.performUseAction", candidateId: "terrain.perform_use_action", semanticFamily: "terrain_interaction", nativeRuleBoundaryCandidate: "TerrainFeature.performUseAction" },
  { ingressId: "world_tool_use", expression: "currentLocation.leftClick", candidateId: "world.left_click", semanticFamily: "world_interaction", nativeRuleBoundaryCandidate: "GameLocation.leftClick" },
  { ingressId: "world_tool_use", expression: "currentLocation.LowPriorityLeftClick", candidateId: "world.low_priority_left_click", semanticFamily: "world_interaction", nativeRuleBoundaryCandidate: "GameLocation.LowPriorityLeftClick" },
  { ingressId: "world_tool_use", expression: "Utility.tryToPlaceItem", candidateId: "item.try_place", semanticFamily: "item_placement", nativeRuleBoundaryCandidate: "Utility.tryToPlaceItem" },
  { ingressId: "world_tool_use", expression: "player.CurrentTool.DoFunction", candidateId: "tool.do_function", semanticFamily: "tool_use", nativeRuleBoundaryCandidate: "Tool.DoFunction" },
  { ingressId: "world_tool_use", expression: "player.BeginUsingTool", candidateId: "tool.begin_using", semanticFamily: "tool_use", nativeRuleBoundaryCandidate: "Farmer.BeginUsingTool" },
  { ingressId: "world_tool_use", expression: "value.performToolAction", candidateId: "object.perform_tool_action", semanticFamily: "object_tool_interaction", nativeRuleBoundaryCandidate: "Object.performToolAction" },
  { ingressId: "world_tool_use", expression: "player.netItemStowed.Set", candidateId: "inventory.stow_toggle", semanticFamily: "inventory_management", nativeRuleBoundaryCandidate: "Farmer.netItemStowed.Set" },
  { ingressId: "world_tool_use", expression: "tool.DoFunction", candidateId: "tool.do_function", semanticFamily: "tool_use", nativeRuleBoundaryCandidate: "Tool.DoFunction" },
  { ingressId: "world_action_interaction", expression: "building.doAction", candidateId: "building.do_action", semanticFamily: "building_interaction", nativeRuleBoundaryCandidate: "Building.doAction" },
  { ingressId: "world_action_interaction", expression: "farmer.checkAction", candidateId: "farmer.check_action", semanticFamily: "farmer_interaction", nativeRuleBoundaryCandidate: "Farmer.checkAction" },
  { ingressId: "world_action_interaction", expression: "currentEvent.checkAction", candidateId: "festival.check_action", semanticFamily: "festival_operation", nativeRuleBoundaryCandidate: "Event.checkAction" },
  { ingressId: "world_action_interaction", expression: "character.checkAction", candidateId: "npc.check_action", semanticFamily: "npc_interaction", nativeRuleBoundaryCandidate: "NPC.checkAction" },
  { ingressId: "world_action_interaction", expression: "resourceClump.performUseAction", candidateId: "resource_clump.perform_use_action", semanticFamily: "resource_source", nativeRuleBoundaryCandidate: "ResourceClump.performUseAction" },
  { ingressId: "world_action_interaction", expression: "value.checkForAction", candidateId: "object.check_for_action", semanticFamily: "object_interaction", nativeRuleBoundaryCandidate: "Object.checkForAction" },
  { ingressId: "world_action_interaction", expression: "value.performObjectDropInAction", candidateId: "object.drop_in", semanticFamily: "machine_or_container_load", nativeRuleBoundaryCandidate: "Object.performObjectDropInAction" },
  { ingressId: "world_action_interaction", expression: "pair.Value.performUseAction", candidateId: "terrain.perform_use_action", semanticFamily: "terrain_interaction", nativeRuleBoundaryCandidate: "TerrainFeature.performUseAction" },
  { ingressId: "world_action_interaction", expression: "largeTerrainFeature.performUseAction", candidateId: "large_terrain.perform_use_action", semanticFamily: "terrain_interaction", nativeRuleBoundaryCandidate: "LargeTerrainFeature.performUseAction" },
  { ingressId: "world_action_interaction", expression: "performAction", candidateId: "map.perform_action", semanticFamily: "map_operation", nativeRuleBoundaryCandidate: "GameLocation.performAction" },
  { ingressId: "world_action_interaction", expression: "checkTileIndexAction", candidateId: "map.tile_index_action", semanticFamily: "map_operation", nativeRuleBoundaryCandidate: "GameLocation.checkTileIndexAction" },
  { ingressId: "world_action_interaction", expression: "who.BeginSitting", candidateId: "seat.begin_sitting", semanticFamily: "furniture_or_seat_interaction", nativeRuleBoundaryCandidate: "Farmer.BeginSitting" },
  { ingressId: "world_action_interaction", expression: "item.checkForAction", candidateId: "furniture.check_for_action", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.checkForAction" },
  { ingressId: "world_action_interaction", expression: "item.clicked", candidateId: "furniture.clicked", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.clicked" },
  { ingressId: "world_action_interaction", expression: "furniture.checkForAction", candidateId: "furniture.check_for_action", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.checkForAction" },
  { ingressId: "world_action_interaction", expression: "furniture.clicked", candidateId: "furniture.clicked", semanticFamily: "furniture_interaction", nativeRuleBoundaryCandidate: "Furniture.clicked" },
  { ingressId: "world_tool_release", rootTarget: true, candidateId: "tool.end_using", semanticFamily: "tool_use", nativeRuleBoundaryCandidate: "Farmer.EndUsingTool" },
  { ingressId: "inventory_toolbar_selection", expression: "player.netItemStowed.Set", candidateId: "inventory.stow_toggle", semanticFamily: "inventory_management", nativeRuleBoundaryCandidate: "Farmer.netItemStowed.Set" },
  { ingressId: "inventory_toolbar_selection", expression: "player.UpdateItemStow", candidateId: "inventory.stow_update", semanticFamily: "inventory_management", nativeRuleBoundaryCandidate: "Farmer.UpdateItemStow" },
  { ingressId: "world_movement", rootTarget: true, candidateId: "movement.set_direction", semanticFamily: "movement", nativeRuleBoundaryCandidate: "Farmer.setMoving" },
  { ingressId: "menu_semantic_selection", rootTarget: true, candidateId: "menu.typed_operation", semanticFamily: "menu_operation", nativeRuleBoundaryCandidate: "IClickableMenu.receive* virtual dispatch" },
  { ingressId: "event_dialogue_or_choice", rootTarget: true, candidateId: "event.pointer_or_dialogue_operation", semanticFamily: "event_operation", nativeRuleBoundaryCandidate: "Event.receiveMouseClick / answerDialogue" },
  { ingressId: "text_chat_submission", rootTarget: true, candidateId: "text_chat.typed_submission", semanticFamily: "text_or_chat", nativeRuleBoundaryCandidate: "TextEntry/ChatBox.receive* virtual dispatch" },
  { ingressId: "minigame_continuous_control", rootTarget: true, candidateId: "minigame.typed_control", semanticFamily: "minigame", nativeRuleBoundaryCandidate: "IMinigame.receive* virtual dispatch" },
]);
...
export const GAME1_PRESS_USE_TOOL_BUTTON_BRANCHES = Object.freeze([
  {
    ...
    requiredFragments: ["player.CurrentTool == null && player.ActiveObject == null", "ItemRegistry.Create<Tool>(\"(T)Pickaxe\")", "value.performToolAction(tool)", "value.performRemoveAction()", "currentLocation.Objects.Remove(key)"],
  ...
  },
  {
    ...
    requiredFragments: ["Utility.canGrabSomethingFromHere", "currentLocation.terrainFeatures.TryGetValue(tile, out var value2)", "value2.performUseAction(tile)"],
  ...
  },
  {
    ...
    requiredFragments: ["options.allowStowing", "CanPlayerStowItem(GetPlacementGrabTile())", "player.netItemStowed.Set(newValue: true)"],
  ...
  },
  {
    ...
    requiredFragments: ["player.ActiveObject != null", "Utility.GetNearbyValidPlacementPosition", "Utility.tryToPlaceItem(currentLocation, player.ActiveObject"],
  ...
  },
  {
    ...
    requiredFragments: ["options.allowStowing", "player.netItemStowed.Value", "player.netItemStowed.Set(newValue: false)"],
...
export const TOOL_OVERRIDE_BRANCHES = Object.freeze([
  ...
  },
  {
    ...
    requiredFragments: ["location.terrainFeatures.TryGetValue(tile, out var value)", "value.performToolAction(this, 0, tile)"],
  ...
  },
  {
    ...
    requiredFragments: ["WaterLeft > 0 || who.hasWateringCanEnchantment", "value.performToolAction(this, 0, item)", "location.performToolAction(this, (int)item.X, (int)item.Y)"],
  ...
  },
  {
    ...
    requiredFragments: ["who.addItemsByMenuIfNecessary(getPanItems(location, who))", "location.orePanPoint.Value = Point.Zero"],
  ...
  },
  {
    ...
    requiredFragments: ["location.canFishHere() && location.isTileFishable(tileX, tileY)", "isFishing = true", "timeUntilFishingBite = calculateTimeUntilFishingBite"],
...
export const TOOL_BEGIN_USING_BRANCHES = Object.freeze([
  {
    ...
    requiredFragments: ["isTimingCast = true", "who.UsingTool = true", "who.canReleaseTool = false", "setTimingCastAnimation(who)"],
...
export const TOOL_END_USING_BRANCHES = Object.freeze([
  {
    ...
    requiredFragments: ["this is FishingRod fishingRod", "who.IsLocalPlayer", "!fishingRod.hit", "DoFunction(who.currentLocation"],
...
export const GAME_LOCATION_CHECK_ACTION_BRANCHES = Object.freeze([
  ...
  // typed equivalence proof before it can become a canonical PRCP.
  {
    ...
    requiredFragments: ["!objects.ContainsKey(new Vector2(tileLocation.X, tileLocation.Y))", "CheckPetAnimal(rectangle, who)"],
  ...
  },
  {
    ...
    requiredFragments: ["currentEvent != null && currentEvent.isFestival", "currentEvent.checkAction(tileLocation, viewport, who)"],
  ...
  },
  {
    ...
    requiredFragments: ["vector == who.Tile", "ItemRegistry.Create<Tool>(\"(T)Pickaxe\")", "value.performToolAction(tool)", "Game1.currentLocation.Objects.Remove(vector)"],
  },
  {
    ...
    requiredFragments: ["value.Type == \"Crafting\" || value.Type == \"interactive\"", "who.ActiveObject == null && value.checkForAction(who)"],
  ...
  },
  {
    ...
    requiredFragments: ["value.performObjectDropInAction(who.CurrentItem, probe: true, who)", "value.performObjectDropInAction(who.CurrentItem, probe: false, who, returnFalseIfItemConsumed: true)", "who.reduceActiveItemByOne()"],
    branchAnchorFragment: "value.performObjectDropInAction(who.CurrentItem, probe: false, who, returnFalseIfItemConsumed: true)",
  },
  {
    ...
    requiredFragments: ["value.isSpawnedObject.Value || isErrorItem", "value.isForage()", "who.couldInventoryAcceptThisItem(value)", "who.addItemToInventoryBool(value.getOne())", "objects.Remove(vector)"],
  ...
  },
  {
    ...
    requiredFragments: ["Game1.didPlayerJustRightClick(ignoreNonMouseHeldInput: true)", "animals.Length > 0", "CheckInspectAnimal(rectangle, who)"],
...
export const PLAYER_INGRESS_ROOTS = Object.freeze([
  ...
  },
  {
    ...
    requiredFragments: ["receiveLeftClick(getMouseX(), getMouseY())", "receiveRightClick(getMouseX(), getMouseY())", "receiveKeyPress("],
  },
  {
    ...
    requiredFragments: ["CurrentEvent?.receiveMouseClick", "pressActionButton(currentKBState, currentMouseState, currentPadState)"],
  },
  {
...
function enclosingBlockRanges(source, offset) {
  ...
  while ((match = conditional.exec(source.slice(0, offset + 1))) !== null) {
    ...
    const end = source[start] === "{"
      ? matchingDelimiter(source, start, "{", "}")
...
const NON_CALL_IDENTIFIERS = new Set([
  "if", "for", "foreach", "while", "switch", "catch", "using", "lock", "return", "new", "typeof", "nameof", "default", "base", "this",
]);
...
export function sourceForType(sourceIndex, typeName) {
  ...
  const normalize = (candidateType, value) => typeof value === "string"
    ? { typeName: candidateType, source: value, sourceFile: `${candidateType.replaceAll(".", "/")}.cs` }
    : value && typeof value.source === "string"
      ? { typeName: candidateType, source: value.source, sourceFile: value.sourceFile ?? `${candidateType.replaceAll(".", "/")}.cs` }
      : null;
...
function reachableSecondHopEdges(gameLocationSource, rootDispatchEdges, ingress, options) {
  ...
  const edges = [];
  const actionRoot = ingress.ingressRoots.find((root) => root.ingressId === "world_action_interaction" && root.classification !== "unknown");
  const toolRoot = ingress.ingressRoots.find((root) => root.ingressId === "world_tool_use" && root.classification !== "unknown");
  const actionReachesCheck = actionRoot && rootDispatchEdges.some((edge) => edge.ingressId === actionRoot.ingressId && edge.to === "tryToCheckAt");
  const toolReachesCheck = toolRoot && rootDispatchEdges.some((edge) => edge.ingressId === toolRoot.ingressId && edge.to === "currentLocation.checkAction");
  ...
  for (const root of [actionRoot, toolRoot].filter(Boolean)) {
    ...
    edges.push(...extractDirectCallEdges(gameLocationSource.source, "checkAction", {
 ...
 */
function sourceBranchCandidates({ source, sourceType, sourceFile, sourceMethod, definitions, ingressId, sourceEdgeIds, reason }) {
  const body = methodBody(source, sourceMethod);
  if (body === null) return [];
  return definitions.map((definition) => {
    const positions = Object.fromEntries(definition.requiredFragments.map((fragment) => [fragment, positionOfAll(body, fragment).slice(0, 8)]));
    ...
    const evidence = candidateOffsets.map((primaryOffset) => {
      ...
      const smallestContainingAll = ranges.find((branchRange) =>
        nonTerminalFragments.every((fragment) => (positions[fragment] ?? []).some((offset) => offset >= branchRange.start && offset <= branchRange.end)),
      );
      ...
      if (definition.allowMethodScope && !enclosingConditionalBlockRange(body, primaryOffset)) return { start: 0, end: body.length };
...
export function game1PressUseToolButtonBranchCandidates(game1Source, rootDispatchEdges, ingress, options = {}) {
  const root = ingress.ingressRoots.find((item) => item.ingressId === "world_tool_use" && item.classification !== "unknown");
  if (!root || !rootDispatchEdges.some((edge) => edge.ingressId === root.ingressId && edge.from.endsWith(".pressUseToolButton"))) return [];
  return sourceBranchCandidates({
    ...
    ingressId: root.ingressId,
    sourceEdgeIds: rootDispatchEdges.filter((edge) => edge.ingressId === root.ingressId && edge.from.endsWith(".pressUseToolButton")).map((edge) => edge.edgeId),
...
export function toolOverrideBranchCandidates(sourceIndex, rootDispatchEdges, ingress) {
  const root = ingress.ingressRoots.find((item) => item.ingressId === "world_tool_use" && item.classification !== "unknown");
  const toolDispatchEdges = rootDispatchEdges.filter((edge) => edge.ingressId === "world_tool_use" && (edge.to.includes("BeginUsingTool") || edge.to.includes("DoFunction")));
...
export function toolBeginUsingBranchCandidates(sourceIndex, beginEdges, ingress) {
  const root = ingress.ingressRoots.find((item) => item.ingressId === "world_tool_use" && item.classification !== "unknown");
  if (!root || !beginEdges.some((edge) => edge.ingressId === root.ingressId && edge.to.includes("beginUsing"))) return [];
  ...
  return sourceBranchCandidates({
    ...
    ingressId: root.ingressId,
    sourceEdgeIds: beginEdges.filter((edge) => edge.ingressId === root.ingressId && edge.to.includes("beginUsing")).map((edge) => edge.edgeId),
...
export function toolEndUsingBranchCandidates(sourceIndex, releaseEdges, ingress) {
  const root = ingress.ingressRoots.find((item) => item.ingressId === "world_tool_release" && item.classification !== "unknown");
  if (!root || !releaseEdges.some((edge) => edge.ingressId === root.ingressId && edge.to.includes("endUsing"))) return [];
  ...
  return sourceBranchCandidates({
    ...
    ingressId: root.ingressId,
    sourceEdgeIds: releaseEdges.filter((edge) => edge.ingressId === root.ingressId && edge.to.includes("endUsing")).map((edge) => edge.edgeId),
...
export function gameLocationCheckActionBranchCandidates(gameLocationSource, rootDispatchEdges, ingress) {
  ...
  if (body === null) return [];
  return GAME_LOCATION_CHECK_ACTION_BRANCHES
    .map((definition) => {
      const positions = Object.fromEntries(definition.requiredFragments.map((fragment) => [fragment, positionOfAll(body, fragment).slice(0, 8)]));
      const contextPositions = Object.fromEntries((definition.contextFragments ?? []).map((fragment) => [fragment, positionOfAll(body, fragment).slice(0, 8)]));
      if (Object.values(positions).some((offsets) => offsets.length === 0) || Object.values(contextPositions).some((offsets) => offsets.length === 0)) return null;
      const anchorFragment = definition.branchAnchorFragment ?? definition.requiredFragments[0];
      const candidateOffsets = positionOfAll(body, anchorFragment).slice(0, 8);
      const evidence = candidateOffsets.map((primaryOffset) => {
        ...
        const terminalFragments = definition.terminalFragments
          ...
          : [];
        const nonTerminalFragments = definition.requiredFragments.filter((fragment) => !terminalFragments.includes(fragment));
        return enclosingBlockRanges(body, primaryOffset).find((branchRange) => {
          if (nonTerminalFragments.some((fragment) => !(positions[fragment] ?? []).some((offset) => offset >= branchRange.start && offset <= branchRange.end))) return false;
          if (terminalFragments.some((fragment) => !positions[fragment].some((offset) => offset >= branchRange.start && offset <= body.length))) return false;
          ...
          if (Object.values(contextPositions).some((offsets) => !offsets.some((offset) => offset <= branchRange.end))) return false;
          return true;
        }) ?? null;
      }).find(Boolean);
      if (!evidence) return null;
      ...
      return {
        ...definition,
        candidateId: definition.sourceVariant ? `${definition.candidateId}.${definition.sourceVariant}` : definition.candidateId,
...
export function gameLocationPerformActionSelectorCandidates(gameLocationSource, sourceBranchCandidates = []) {
  if (!gameLocationSource || !sourceBranchCandidates.some((candidate) => candidate.candidateId === "map.action_property")) return [];
...
export function extractDirectCallEdges(source, methodName, {
  sourceType = "StardewValley.Game1",
 ...
 */
export function extractPlayerIngressRoots(game1Source, {
  sourceFile = "StardewValley/Game1.cs",
  sourceType = "StardewValley.Game1",
} = {}) {
...
export function buildPlayerCommandGraph(game1Source, options = {}) {
  ...
  const releaseLifecycleEdges = ingress.ingressRoots
    ...
    .flatMap((root) => extractDirectCallEdges(game1Source, root.sourceMethod, {
      sourceFile: ingress.sourceFile,
      ingressId: root.ingressId,
    }).filter((edge) => edge.to === "player.EndUsingTool"));
  const toolReleaseSecondHopEdges = farmerSource && releaseLifecycleEdges.length > 0
    ? extractDirectCallEdges(farmerSource.source, "performEndUsingTool", {
      ...
      ingressId: "world_tool_release",
    }).filter((edge) => edge.to.includes("endUsing")).map((edge) => ({
      ...edge,
    ...
    : [];
  const toolBeginSecondHopEdges = farmerSource && rootDispatchEdges.some((edge) => edge.ingressId === "world_tool_use" && edge.to.includes("BeginUsingTool"))
    ? extractDirectCallEdges(farmerSource.source, "performBeginUsingTool", {
      sourceType: farmerSource.typeName,
      sourceFile: farmerSource.sourceFile,
      ingressId: "world_tool_use",
    }).filter((edge) => edge.to.includes("beginUsing")).map((edge) => ({
      ...edge,
  ...
  const menuDispatchEdges = ingress.ingressRoots
    ...
    .flatMap((root) => extractDirectCallEdges(game1Source, root.sourceMethod, {
      sourceFile: ingress.sourceFile,
      ingressId: root.ingressId,
    }).filter((edge) => /(?:childMenu|active_menu|chatBox)\.(?:receive|release|leftClickHeld|gamePadButtonHeld)|CurrentEvent\.receiveMouseClick/.test(edge.to)));
  const eventDispatchEdges = ingress.ingressRoots
    ...
    .flatMap((root) => extractDirectCallEdges(game1Source, "updateActiveMenu", {
      sourceFile: ingress.sourceFile,
      ingressId: root.ingressId,
    }).filter((edge) => /CurrentEvent\.(?:receiveMouseClick|skipEvent)|childMenu\.receive|chatBox\.receive/.test(edge.to)));
  const allCandidateEdges = [...rootEdges, ...rootDispatchEdges, ...worldCheckActionEdges, ...toolBeginSecondHopEdges, ...releaseLifecycleEdges, ...toolReleaseSecondHopEdges, ...menuDispatchEdges, ...eventDispatchEdges, ...textDispatchEdges, ...minigameDispatchEdges];
  const seenEdgeIds = new Set();
  const reachableEdges = allCandidateEdges.filter((edge) => !seenEdgeIds.has(edge.edgeId) && seenEdgeIds.add(edge.edgeId));
  ...
  const toolUseBranchCandidates = game1PressUseToolButtonBranchCandidates(game1Source, rootDispatchEdges, ingress, { sourceFile: ingress.sourceFile });
  ...
  const sourceBranchCandidates = gameLocationCheckActionBranchCandidates(gameLocationSource, rootDispatchEdges, ingress);
  const mapActionSelectorCandidates = gameLocationPerformActionSelectorCandidates(gameLocationSource, sourceBranchCandidates);
  const candidatePairs = PLAYER_COMMAND_BOUNDARY_CANDIDATES
    .filter((candidate) => {
      if (candidate.rootTarget) return ingress.ingressRoots.some((root) => root.ingressId === candidate.ingressId && root.classification === "command_path_candidate");
    ...
    .map((candidate) => {
      ...
      return [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, {
        ...candidate,
        ...
        sourceEvidence: {
          ...
          anchorPositions: Object.fromEntries(sourceEdges.map((edge) => [edge.edgeId, Number.isInteger(edge.sourceOffset) ? [edge.sourceOffset] : []])),
        },
        status: "boundary_candidate",
        route: null,
  ...
  const candidatePairsWithBranches = [
    ...
    ...toolUseBranchCandidates.map((candidate) => [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, candidate]),
    ...toolOverrideCandidates.map((candidate) => [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, candidate]),
    ...toolBeginCandidates.map((candidate) => [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, candidate]),
    ...toolReleaseCandidates.map((candidate) => [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, candidate]),
    ...sourceBranchCandidates.map((candidate) => [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, candidate]),
    ...mapActionSelectorCandidates.map((candidate) => [`${candidate.ingressId}/${candidate.candidateId}/${candidate.nativeRuleBoundaryCandidate}`, candidate]),
  ];
  const commandPathCandidates = [...new Map(candidatePairsWithBranches).values()]
    .sort((left, right) => `${left.ingressId}/${left.candidateId}/${left.nativeRuleBoundaryCandidate}`.localeCompare(`${right.ingressId}/${right.candidateId}/${right.nativeRuleBoundaryCandidate}`));
  ...
  const pendingByIngress = ingress.ingressRoots
    ...
    .map((root) => ({
      ...
      candidateEdgeCount: reachableEdges.filter((edge) => edge.classification === "candidate_dispatch_edge" && (edge.ingressId === root.ingressId || edge.from.includes(`:${root.ingressId}`))).length,
      commandBoundaryCandidateCount: commandPathCandidates.filter((candidate) => candidate.ingressId === root.ingressId).length,
