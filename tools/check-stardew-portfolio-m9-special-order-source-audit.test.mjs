...
const root = resolve(".");
const script = resolve("tools/check-stardew-portfolio-m9-special-order-source-audit.mjs");
function run() {
...
test("M9 source-audit CLI revalidates authority, provenance metadata, and bounded local anchors", async () => {
