...
const root = resolve(".");
const script = resolve("tools/check-stardew-portfolio-m4-resource-source-audit.mjs");
function run() {
...
test("M4 source-audit CLI revalidates authority, provenance metadata, and bounded local anchors", async () => {
