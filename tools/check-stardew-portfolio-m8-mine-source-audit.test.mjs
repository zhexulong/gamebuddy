...
const root = resolve(".");
const script = resolve("tools/check-stardew-portfolio-m8-mine-source-audit.mjs");
function run() {
...
test("M8 source-audit CLI revalidates authority, provenance metadata, and bounded local anchors", async () => {
