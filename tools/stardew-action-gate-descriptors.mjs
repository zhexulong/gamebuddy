...
export const STARDEW_PUBLISHED_ACTION_GATES = Object.freeze([
  ...
  gate("pickup_forage", "run-stardew-native-local-player-pickup-forage-smoke.mjs", "forage_picked_up", "native_pickup_forage_v1"),
  gate("pickup_item", "run-stardew-native-local-player-pickup-item-smoke.mjs", "item_picked_up", "native_pickup_item_v1"),
