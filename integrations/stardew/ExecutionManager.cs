...
internal sealed partial class ExecutionManager
{
    ...
    public ExecutionManager(
        IMonitor monitor,
        FarmhandCapabilitySurface capabilitySurface,
        Action<LocalExecutionReceipt>? receiptPublished = null,
        Action<ExecutionTrace>? tracePublished = null)
    {
        this.monitor = monitor;
        this.capabilitySurface = capabilitySurface ?? throw new ArgumentNullException(nameof(capabilitySurface));
    ...
    public object CreateSnapshot()
    {
        ...
        return new
        {
            ...
            capabilities = this.capabilitySurface.Capabilities,
    ...
    {
        Farmer? player = Game1.player;
        IReadOnlyList<string> advertisedCapabilities = this.capabilitySurface.Capabilities;
        if (player is null)
